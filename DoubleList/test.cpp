...
int main(){
  ...
  DList<char> test(arr,arrSize);
  ListNode<char>* head = test.CreatAList_Loop();
  test.DisplayList();
  cout<<"Default use Loop ,there dosen't have any function for Nor_loop DList!!"<<endl;
  ...
  cout<<"9.SetNodeHead"<<" "<<"10.SetNodeTail"<<endl;
  do{
    cin>>choose;
    switch(choose){
      case 0:
        {
          cout<<"Exit test Function!!"<<endl;
          break;
        }
      case 1:
        {
      ...
      default:
        cout<<"illegal test fun number,now quit!! "<<endl;
    }
  }while(choose!=0);
  return 0;
}
